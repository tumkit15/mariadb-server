...
FUNCTION(MY_CHECK_AND_SET_LINKER_FLAG flag_to_set)
  ...
  ENDIF()
  STRING(REGEX REPLACE "^-Wno-" "-W" flag_to_check ${flag_to_set})
  STRING(REGEX REPLACE "[-,= +]" "_" result "linker_check_${flag_to_check}")
  SET(SAVE_CMAKE_REQUIRED_LIBRARIES "${CMAKE_REQUIRED_LIBRARIES}")
  SET(CMAKE_REQUIRED_LIBRARIES "${flag_to_check}")
  CHECK_C_SOURCE_COMPILES("int main(void) { return 0; }" C_${result} ${fail_patterns})
  CHECK_CXX_SOURCE_COMPILES("int main(void) { return 0; }" CXX_${result} ${fail_patterns})
  SET(CMAKE_REQUIRED_LIBRARIES "${SAVE_CMAKE_REQUIRED_LIBRARIES}")
  IF (C_${result} AND CXX_${result})
    SET(LINK_FLAGS "${flag_to_set} ${LINK_FLAGS}")
  ENDIF()
ENDFUNCTION()
